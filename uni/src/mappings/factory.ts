...
import { FACTORY_ADDRESS, ZERO_BI, ONE_BI, ZERO_BD, ADDRESS_ZERO, INCLUDED_PAIRS } from './../utils/constants'
...
export function handlePoolCreated(event: PoolCreated): void {
  ...
  log.info('new pair {}', [event.params.pool.toHexString()])
  if (INCLUDED_PAIRS.includes(event.params.pool.toHexString())) {
    log.info('new pair template', [])
